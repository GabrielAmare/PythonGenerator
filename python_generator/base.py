...
__all__ = [
    "PASS", "CONTINUE", "BREAK",
    "STATEMENT", "DEF", "CLASS", "FOR", "WHILE", "IF", "ASSIGN", "SETATTR", "SETITEM",
    ...
    "ADD", "SUB", "MUL", "TRUEDIV",
    "COMPREHENSION", "GENECOMP", "LISTCOMP",
    "OBJECT", "TYPED_OBJECT", "GETATTR", "GETITEM", "CALL", "VAR", "INT", "STR", "FSTR", "LIST", "DICT",
    "TUPLE",
    "SELF", "CLS",
    "AS_KWARG", "AS_ARG",
    "COMPARISON", "NOT", "EQ", "NE", "LT", "LE", "GT", "GE", "IN", "NOT_IN", "IS", "IS_NOT",
    "ARGS", "ARG",
